...
def coverage_bins(bam_file, string_bed_bins, name, to_string=False):
    ...
    for x_line in open_file_fast(string_bed_bins):
...
def get_normalized_count_in_bed_region_given_a_mark(bam, bed_target, analysis_name):
    ...
    cov = coverage_bins(bam_file=sort_bam, string_bed_bins=bed_target, name=analysis_name)
    norma = __normalization__(cov, factor)
    os.system('rm {}'.format(cov))

    return norma

def get_several_normalized_count_in_bed_region_given_a_mark(hash_bam, bed_target):
    '''
    ...
    all_results_dict = {name_analysis:get_normalized_count_in_bed_region_given_a_mark(bam=bam, bed_target=bed_target, analysis_name=name_analysis) for name_analysis, bam in hash_bam.iteritems()}
...
def get_groups_normalized_count_in_bed_region_given_a_mark(hash_in_groups_bam, bed_target_hash):
    '''
    ...
    for bed_name, bed_file_group in  hash_in_groups_bam.iteritems():
        ...
        all_results_dict = {name_analysis:get_normalized_count_in_bed_region_given_a_mark(bam=bam, bed_target=bed_target, analysis_name=name_analysis) for name_analysis, bam in hash_group_bed.iteritems()}
...
def main():
    ...
    # print get_normalized_count_in_bed_region_given_a_mark(bam= '/work/users/lucassilva/chromhmm/sra_dir/peaks_hmm/H3K4me1/H3K4me1.bam',
    #                                                 bed_target='/work/users/lucassilva/chromhmm/sra_dir/peaks_hmm/AR_24/AR_24.bed',
    #                                                 analysis_name='H3K4ME1')
    ...
    bam_groups = {'amostra1':{'H3K4ME1':'/work/users/lucassilva/chromhmm/sra_dir/peaks_hmm/H3K4me1/H3K4me1.bam',
                              'H3K4ME3':'/work/users/lucassilva/chromhmm/sra_dir/peaks_hmm/H3K4me1/H3K4me1.bam'},


                  'amostra2':{'H3K4ME1':'/work/users/lucassilva/chromhmm/sra_dir/peaks_hmm/H3K4me1/H3K4me1.bam',
                              'H3K4ME3':'/work/users/lucassilva/chromhmm/sra_dir/peaks_hmm/H3K4me1/H3K4me1.bam'}
    ...
    bed_target_hash = {'amostra1':'/work/users/lucassilva/chromhmm/sra_dir/peaks_hmm/AR_24/AR_24.bed',

                       'amostra2':'/work/users/lucassilva/chromhmm/sra_dir/peaks_hmm/AR_24/AR_24.bed',
                       }
    ...
    t#able_df = pd.read_table('/home/lucas/PycharmProjects/Epigenetic_manager/EpiManager/tabela_grupo.txt', delimiter='\t')
